...
<body>
    ...
    @section('content')
        <h1> SELECCIONE DETENIDAMENTE LAS OPCIONES QUE CORRESPONDA PARA EL TRAMITE DE LICENCIA</h1>
        <br>
        <fieldset>
            @if (session('success'))
            ...
            @endif
            <form class="row g-3" method="POST" action="{{ route('licencias') }}">
                @csrf
                <div class="col-md-77">
                ...
                <div class="col-md-4">
                    <legend for="DepartamentoSolicitante" class="form-label">DEPARTAMENTO</legend>
                ...
                <div class="col-md-4">
                    <legend for="Gestor" name="Gestor" class="form-label">CENTRO DE GESTOR:</legend>
                    <select class="form-select" id="Gestor" required>
                        <option selected disabled value="">SELECCIONE...</option>
                        <option>GR42</option>
                        <option>GR44</option>
                        <option>GT41</option>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" maxlength="255" class="form-control" name="comentario_trabajo_realizar"
                        placeholder="Escribir el trabajo a realizar" id="TrabajoRealizar" required>
                </div>
                <br>
                <div class="col-md-80">
                    ...
                    <input type="text" maxlength="255" class="form-control"
                        ...
                        name="comentario_especifico" id=" Instrucciones" required>
                </div>
                <div class="container">
                    <br>
                    <div class="col-md-80">
                        ...
                        <div class="col">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <input type="text" id="Otros" name="maniobrar[]">
                                </li>
                            </ul>
                        </div>
                        <div class="col">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <label for="checkbox22">13. AISLAR</label>
                                </li>
                            </ul>
                            <ul>
                                <li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <input type="text" id="Otros3" name="asegurar[]">
                                </li>
                            </ul>
                        </div>
                        <div class="col">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <label form="checkbox26">17. MECÁNICAMENTE</label>
                                </li>
                            </ul>
                            <ul>
                                <li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <label for="checkbox32">21. PROTECCIONES</label>
                                </li>
                            </ul>
                            <ul>
                                <li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <input type="text" id="Otros2" name="bloquear[]">
                                </li>
                            </ul>
                        </div>
                    </div>
